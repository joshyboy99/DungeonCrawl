package unsw.dungeon.unitTesting;
...
class TestSwordEnemy {
    @Test
    void testEnemyIsDestroyedIfHitWithSword() {

    }
      
    @Test
    void testEnemeyIsRemovedFromLevelWhenDestroyed() {
        
    }
    
    @Test
    void testPlayerTriesToHitEnemyButMisses() {

    }
    
    @Test
    void testSwordUsedUp() {
    	
    }
    
    @Test
    void testSwordDoesntHit() {
